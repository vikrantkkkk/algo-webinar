...
const LogoMarquee = () => {
  ...
  return (
    <div className="bg-[#010611] text-white flex flex-col items-center md:px-40 pt-16 gap-4 w-full">
      <div className="flex flex-col md:gap-5 gap-2 justify-center items-center w-screen md:py-5 py-2">
        <AnimateFromInside>
          <h2 className="flex items-center gap-2 font-medium text-[24px] leading-6">
            Powerful AI{" "}
            <span>
              <img
                src={staricon}
