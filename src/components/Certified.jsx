...
const Certified = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row items-center justify-center md:justify-between gap-10 bg-[#010611] w-full h-auto pt-28 pb-8 md:px-40 px-4">
      {/* Left Section */}
